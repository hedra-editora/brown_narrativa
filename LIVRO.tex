\documentclass[semcabeco,showtrims,compontinhos,12pt,conselho,spreadimages]{memoir}
...
\renewcommand{\thechapter}{\thechapter .\arabic{chapter}}
...
\hyphenation{fun-cio-na-men-to}
\hyphenation{abre-via-men-tos}
